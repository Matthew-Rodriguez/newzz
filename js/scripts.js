(function($) {
	$(document).ready(function() {
		...
		$("#typewriter").typewriter({
			prefix : "",
			text : ["Zina Saro-Wiwa", "Zina Saro-Wiwa", "Zina Saro-Wiwa"],
			typeDelay : 100,
			waitingTime : 1500,
			blinkSpeed : 800
		});
		...
		// SANDWICH BUTTON
		$('.sandwich-btn, .sandwich-text').on('click', function(e) {
	...
	$('.sandwich-text').on('click', function(e) {
